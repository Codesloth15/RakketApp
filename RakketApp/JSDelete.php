...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img-resource/Raket.png" id="logo"></a>
 ...
 --> 
    ...
    <div class="Profile-container">
        <div class="side-menu">
            ...
            <a href="JSAlert.php"><h2>Alert</h2></a>  
            <a href="#"><h2>Jobs</h2></a>
        ...
        <div class="create-prof">
            ...
            <form class="form-horizontal">
                <label for="first-name">Enter "DELETE" to proceed.</label>
                <br>
                <input type="text" id="first-name" class="input-area" placeholder="DELETE" autocomplete="off" >
                <br>
                <br>
                <br>
